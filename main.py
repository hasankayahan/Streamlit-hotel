...
st.set_page_config(page_title="Hotel Reservations", layout="wide")
...
if page == "Prediction":
    ...
    with col2:
        st.title("Reservia")
        image_url = "https://r.resimlink.com/eubELkqMB.jpeg?v=f2dcb200e18bbe58a9b35571426f72c1"
        st.image(image_url, use_column_width=True)
    ...
    with col2:
        link = "[Veri Bilimi Okulu](https://resimlink.com/eubELkqMB)"
        st.markdown(link, unsafe_allow_html=True)
    ...
    with col3:
        st.title("Linkedin")
        st.write("[Hanife Öztürk](https://www.linkedin.com/in/hanife-%C3%B6zt%C3%BCrk-53221982/)")
    with col3:
        st.write("[Hasan Kayahan](https://www.linkedin.com/in/hasankayahan/)")
    with col3:
        st.write("[Mehmet Furkan Ketenci](https://www.linkedin.com/in/mehmet-furkan-ketenci/)")
    with col3:
        st.write("[Murat Şen](https://www.linkedin.com/in/muratsen94/)")
    with col3:
        st.write("[Sümeyye Korkmaz Nalbat](https://www.linkedin.com/in/s%C3%BCmeyye-korkmaz-nalbat/)")

    st.title("Data Wizards")
